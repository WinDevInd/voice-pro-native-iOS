...
**YOU ARE IN: `Voice_pro_native_iOS/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/Voice_pro_native_iOS/` (rig root) or other directories
...
**Your mail address:** `Voice_pro_native_iOS/polecats/furiosa`
**Your rig:** Voice_pro_native_iOS
**Your Witness:** `Voice_pro_native_iOS/witness`
...
| Ask Witness for help | `gt mail send Voice_pro_native_iOS/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`Voice_pro_native_iOS/witness`) when:
...
```bash
gt mail send Voice_pro_native_iOS/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
